...
In your Drift database file, define a table for your model. Make sure to include the `DriftSyncTableMixin` to add the necessary synchronization columns (`updatedAt`, `scopeName`, etc.).
...
// 1. Define the table with the DriftSyncTableMixin
@DataClassName('Todo')
